             ...
             <div class="container m-2">
                <div class="card card-body" id="section2">
                  ...
                  <div class="card card-body" id="section4">
                    <h3>References</h3>
                    MDN Web Docs. (2018). HTTP cookies. [online] Available at: https://developer.mozilla.org/en-US/docs/Web/HTTP/Cookies [Accessed 11 May 2018].<br>
                    Morris, J. (2018). How to Build a PHP Login Form Using Sessions - John Morris. [online] John Morris. Available at: https://www.johnmorrisonline.com/build-php-login-form-using-sessions/ [Accessed 11 May 2018].<br>
                    Php.net. (2018). PHP: Introduction - Manual. [online] Available at: http://php.net/manual/en/intro.session.php [Accessed 11 May 2018].<br>
                    Tutorialrepublic.com. (2018). How to Create, Access and Destroy Sessions in PHP - Tutorial Republic. [online] Available at: https://www.tutorialrepublic.com/php-tutorial/php-sessions.php [Accessed 11 May 2018].<br>
                    Tutorialrepublic.com. (2018). PHP If, Else and Elseif Conditional Statements - Tutorial Republic. [online] Available at: https://www.tutorialrepublic.com/php-tutorial/php-if-else-statements.php [Accessed 11 May 2018]. <br>
                    Tutorialrepublic.com. (2018). PHP Switch Case Conditional Statements - Tutorial Republic. [online] Available at: https://www.tutorialrepublic.com/php-tutorial/php-switch-case-statements.php [Accessed 11 May 2018].<br>
                    Tutorialrepublic.com. (2018). PHP While, Do-While, For and Foreach Loops - Tutorial Republic. [online] Available at: https://www.tutorialrepublic.com/php-tutorial/php-loops.php [Accessed 11 May 2018].<br>
